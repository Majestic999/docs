...
Connect HC-05 TX to ESP32 board D2 (use a voltage divider) and HC-05 RX to ESP32 board D3.

**Step 3:** Connect the MAX7219 Dot Matrix: Connect VCC to 5V and GND to GND.

Connect DIN to ESP32 board D12, CS to ESP32 board D10, and CLK to ESP32 board D11.

**Step 4:** Connect the Active Buzzer: Connect the positive pin (+) to ESP32 board D9 and the negative pin (-) to GND.
